...
const section = [
  {
    items: [
      ...
      { image: "https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-text,ie-U2F0LCAyNCBBdWcgb253YXJkcw%3D%3D,fs-29,co-FFFFFF,ly-612,lx-24,pa-8_0_0_0,l-end/et00392317-ekaqamgvae-portrait.jpg", title: "Nothing Makes Sense FT. Splash Pad", genre: "Event", rating: 9.1, ratingType: 'star', votes: "41.9K Votes" },
